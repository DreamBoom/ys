...
public class EditInputFilter2 implements InputFilter {
...
//        dend
        ...
        if (sumText > MAX_VALUE) {
            Toast.makeText(MyApplication.Companion.getContext(), "金额超出限制", Toast.LENGTH_SHORT).show();
