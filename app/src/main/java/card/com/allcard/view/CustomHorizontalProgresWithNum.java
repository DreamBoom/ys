...
public class CustomHorizontalProgresWithNum extends ProgressBar{
    ...
    protected static final int DEAFUALT_PROGRESS_REACH_CORLOR = 0xFF598bf1;
    protected static final int DEAFUALT_PROGRESS_TEXT_SIZE = 10;//sp
    protected static final int DEAFUALT_PROGRESS_TEXT_CORLOR = 0xFF598bf1;
...
//        typedArray.recycle();//记得加这句
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        if (progressX  < getWidth() - getPaddingLeft() - getPaddingRight()){//进度走完了,不再画未走完的
            ...
            RectF mRectF2 = new RectF(progressX ,getPaddingTop()-HorizontalProgresUnReachHeight/2,realWidth,HorizontalProgresUnReachHeight/2);//圆角 int left, int top, int right, int bottom
