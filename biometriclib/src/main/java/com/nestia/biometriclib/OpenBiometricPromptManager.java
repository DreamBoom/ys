 ...
 */
public class OpenBiometricPromptManager {

    private OpenIBiometricPromptImpl mImpl;
    ...
    public static OpenBiometricPromptManager from(Activity activity) {
        return new OpenBiometricPromptManager(activity);
    }

    public OpenBiometricPromptManager(Activity activity) {
        mActivity = activity;
        if (isAboveApi28()) {
            mImpl = new OpenBiometricPromptApi23(activity);
    ...
    public boolean hasEnrolledFingerprints() {
        if (isAboveApi28()) {
            ...
            return ((OpenBiometricPromptApi23)mImpl).hasEnrolledFingerprints();
        } else {
            return false;
        }
    }
    ...
    public boolean isHardwareDetected() {
        if (isAboveApi28()) {
            ...
            return ((OpenBiometricPromptApi23)mImpl).isHardwareDetected();
        } else {
            return false;
        }
    }
