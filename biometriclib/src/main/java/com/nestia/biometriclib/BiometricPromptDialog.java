...
public class BiometricPromptDialog extends DialogFragment {
    ...
    private Callback mDialogActionCallback;
    public ImageView line;
    public ImageView im_finger;
    ...
    public void setOnBiometricPromptDialogActionCallback(Callback callback) {
...
//        }, 200);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        im_finger = view.findViewById(R.id.im_finger);
        tvInfo = view.findViewById(R.id.tv_pop_info);
        login_again = view.findViewById(R.id.login_again);
    ...
    public void setState(int state) {
        switch (state) {
            ...
            case STATE_FAILED:
                ...
                break;
            case STATE_ERROR:
                tvInfo.setText("验证失败，请通过密码登录");
                line.setVisibility(View.VISIBLE);
                login_again.setVisibility(View.VISIBLE);
                break;
            case STATE_SUCCEED:
                dismiss();
